						...
						<div class="col">
							...
							<div class="col" style="margin-top: 30px;">
								...
								<div class="row" style = "float: left; width:200px;">
									<span style="font-size: 22px; text-decoration: none; text-align: center;  border:1px solid; margin-left: 10px; font-weight: bold; border-color:orange; color: #ff3366;" id = "avgvalue0"><b>5.0</b></span>
								</div>
					...
					<div class="row"style="float: left; width:500px; margin-left: 20px; ">
						...
						<div class="col">
							...
							<div class="col" style="margin-top: 30px;">
								...
								<div class="row" style = "float: left; width:200px;">
									<span style="font-size: 22px; text-decoration: none; text-align: center; border:1px solid; margin-left: 10px; font-weight: bold; border-color:orange; color: #ff3366;" id = "avgvalue1">5.0</span>
								</div>
					...
					<div class="row"style="float: left; width:500px; margin-left: 20px; ">
						...
						<div class="col">
							...
							<div class="col" style="margin-top: 30px;">
								...
								<div class="row" style = "float: left; width:200px;">
									<span style="font-size: 22px; text-decoration: none; text-align: center; border:1px solid; margin-left: 10px; font-weight: bold; border-color:orange; color: #ff3366;" id = "avgvalue2">5.0</span>
								</div>
					...
					<div class="row"style="float: left; width:500px; margin-left: 20px; ">
						...
						<div class="col">
							...
							<div class="col" style="margin-top: 30px;">
								...
								<div class="row" style = "float: left; width:200px;">
									<span style="font-size: 22px; text-decoration: none; text-align: center; border:1px solid; margin-left: 10px; font-weight: bold; border-color:orange; color: #ff3366;" id = "avgvalue3">5.0</span>
								</div>
					...
					<div class="row"style="float: left; width:500px; margin-left: 20px; ">
						...
						<div class="col">
							...
							<div class="col" style="margin-top: 30px;">
								...
								<div class="row" style = "float: left; width:200px;">
									<span style="font-size: 22px; text-decoration: none; text-align: center; border:1px solid; margin-left: 10px; font-weight: bold; border-color:orange; color: #ff3366;" id = "avgvalue4">5.0</span>
								</div>
	...
	$.ajax({
		...
		success : function(response) {
			...
			//	console.log(idx);
				...
				markerinput(response[idx].restaurantLatitude,response[idx].restaurantLongtitude,response[idx].restaurantName);
